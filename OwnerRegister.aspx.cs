...
namespace SkylineQueries
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into ownreg values('" + DropDownList1.SelectedItem + "','" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + DropDownList2.SelectedItem + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + Label13.Text + "','" + Label14.Text + "','Not Approved')", con);
            cmd.ExecuteNonQuery();
            con.Close();
